# Создаем обновленный data.js файл
data_js_content = """// Файл: data.js
...
const messageTemplates = {
  welcome: (firstName) => `👋 Приветствую, ${firstName}!\\n\\nЯ бот Александра Попова, инструктора по дыхательной гимнастике по методу Бутейко. Через меня вы можете приобрести курсы и получить материалы.\\n\\nЧем могу помочь?`,
...
print("✅ Файл data.js создан")
print("\n📋 Изменения в data.js:")
print("- Разовая консультация: 2 000 ₽ → 5 000 ₽")
print("- Пакет: 3 занятия за 4 500 ₽ → 5 занятий за 22 000 ₽")
print("- Имя инструктора: Анастасия Попова → Александр Попов")
